...
//    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:size options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:detailsLabel.font} context:<#(nullable NSStringDrawingContext *)#>]
//    CGSize size = detailsLabel.size;
